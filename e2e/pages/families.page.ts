...
export class FamiliesPage extends BasePage {
  ...
  async gotoBirthdaysReport(): Promise<void> {
    ...
    await this.page
      .getByTestId("family-birthdays-report")
