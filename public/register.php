				...
				<div class="card-body">
					...
					<div class="form-group basic" style="display: none" id="div_userLegalResponsibleName">
						<div class="input-wrapper">
							...
							<input type="text" class="form-control" id="userLegalResponsibleName"
					...
					<div class="form-group basic" style="display: none" id="div_userLegalResponsibleDoc">
						<div class="input-wrapper">
							...
							<input type="text" class="form-control" id="userLegalResponsibleDoc"
					...
					<div class="custom-control custom-checkbox mt-2 mb-1">
						<div class="form-check">
							...
							<label class="form-check-label" for="policyCheckbox">
								Eu aceito os <a href="#" data-bs-toggle="modal"
									data-bs-target="#policiesModal">Políticas de Usuário</a>.
							</label>
						</div>
					</div>
					<div class="custom-control custom-checkbox mt-2 mb-1">
						<div class="form-check">
							...
							<label class="form-check-label" for="termCheckbox">
								Eu aceito os <a href="#" data-bs-toggle="modal" data-bs-target="#termsModal">Termos e
									Condições de Usuário</a>.
							</label>
						</div>
					</div>
