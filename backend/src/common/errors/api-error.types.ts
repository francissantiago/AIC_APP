...
export const ApiErrorCode = {
  ...
  USERS_MEMBER_NOT_FOUND: 'USERS.MEMBER_NOT_FOUND',
  USERS_MEMBER_ALREADY_LINKED: 'USERS.MEMBER_ALREADY_LINKED',
  ...
  CONGREGATIONS_CONSOLIDATED_HQ_ONLY: 'CONGREGATIONS.CONSOLIDATED_HQ_ONLY',
  ...
  MISSIONS_BOOKLET_NOT_FOUND: 'MISSIONS.BOOKLET_NOT_FOUND',
  MISSIONS_BOOKLET_INVALID_DESTINATION: 'MISSIONS.BOOKLET_INVALID_DESTINATION',
  MISSIONS_BOOKLET_CANCELLED: 'MISSIONS.BOOKLET_CANCELLED',
  MISSIONS_BOOKLET_INSTALLMENT_NOT_FOUND:
    'MISSIONS.BOOKLET_INSTALLMENT_NOT_FOUND',
  MISSIONS_BOOKLET_INSTALLMENT_ALREADY_PAID:
    'MISSIONS.BOOKLET_INSTALLMENT_ALREADY_PAID',
  MISSIONS_BOOKLET_INSTALLMENT_CANCELLED:
    'MISSIONS.BOOKLET_INSTALLMENT_CANCELLED',
  MISSIONS_BOOKLET_INSTALLMENT_NOT_PENDING:
    'MISSIONS.BOOKLET_INSTALLMENT_NOT_PENDING',
  MISSIONS_CATEGORY_NOT_FOUND: 'MISSIONS.CATEGORY_NOT_FOUND',
  ...
  CONSTRUCTIONS_STAGE_NOT_FOUND: 'CONSTRUCTIONS.STAGE_NOT_FOUND',
  ...
  SOCIAL_PROJECTS_NOT_FOUND: 'SOCIAL_PROJECTS.NOT_FOUND',
  SOCIAL_PROJECTS_NAME_CONFLICT: 'SOCIAL_PROJECTS.NAME_CONFLICT',
  SOCIAL_PROJECTS_LEADER_NOT_FOUND: 'SOCIAL_PROJECTS.LEADER_NOT_FOUND',
  SOCIAL_PROJECTS_LEADER_WRONG_CONGREGATION:
    'SOCIAL_PROJECTS.LEADER_WRONG_CONGREGATION',
  SOCIAL_PROJECTS_MEMBER_NOT_FOUND: 'SOCIAL_PROJECTS.MEMBER_NOT_FOUND',
  SOCIAL_PROJECTS_MEMBER_WRONG_CONGREGATION:
    'SOCIAL_PROJECTS.MEMBER_WRONG_CONGREGATION',
  SOCIAL_PROJECTS_MEMBER_ALREADY_LINKED:
    'SOCIAL_PROJECTS.MEMBER_ALREADY_LINKED',
  SOCIAL_PROJECTS_MEMBER_LINK_NOT_FOUND:
    'SOCIAL_PROJECTS.MEMBER_LINK_NOT_FOUND',
  SOCIAL_PROJECTS_SESSION_NOT_FOUND: 'SOCIAL_PROJECTS.SESSION_NOT_FOUND',
  SOCIAL_PROJECTS_SESSION_DATE_CONFLICT:
    'SOCIAL_PROJECTS.SESSION_DATE_CONFLICT',
  SOCIAL_PROJECTS_ATTENDANCE_MEMBER_NOT_PARTICIPANT:
    'SOCIAL_PROJECTS.ATTENDANCE_MEMBER_NOT_PARTICIPANT',
  SOCIAL_PROJECTS_EXPENSE_NOT_FOUND: 'SOCIAL_PROJECTS.EXPENSE_NOT_FOUND',
  SOCIAL_PROJECTS_CATEGORY_NOT_FOUND: 'SOCIAL_PROJECTS.CATEGORY_NOT_FOUND',
} as const;
...
export const ApiErrorMessage = {
  ...
  [ApiErrorCode.USERS_MEMBER_NOT_FOUND]:
    'Membro não encontrado nesta congregação.',
  [ApiErrorCode.USERS_MEMBER_ALREADY_LINKED]:
  ...
  [ApiErrorCode.MISSIONS_BOOKLET_NOT_FOUND]:
    'Carnê missionário não encontrado.',
  [ApiErrorCode.MISSIONS_BOOKLET_INVALID_DESTINATION]:
    'Destinação inválida para o carnê missionário.',
  [ApiErrorCode.MISSIONS_BOOKLET_CANCELLED]: 'Carnê missionário cancelado.',
  [ApiErrorCode.MISSIONS_BOOKLET_INSTALLMENT_NOT_FOUND]:
    'Parcela do carnê não encontrada.',
  [ApiErrorCode.MISSIONS_BOOKLET_INSTALLMENT_ALREADY_PAID]:
    'Parcela já quitada.',
  [ApiErrorCode.MISSIONS_BOOKLET_INSTALLMENT_CANCELLED]: 'Parcela cancelada.',
  [ApiErrorCode.MISSIONS_BOOKLET_INSTALLMENT_NOT_PENDING]:
    'Somente parcelas pendentes podem ser canceladas.',
  [ApiErrorCode.MISSIONS_CATEGORY_NOT_FOUND]:
    'Categoria financeira Missões não encontrada.',
  ...
  [ApiErrorCode.CONSTRUCTIONS_STAGE_NOT_FOUND]: 'Etapa da obra não encontrada.',
  ...
  [ApiErrorCode.SOCIAL_PROJECTS_NOT_FOUND]: 'Projeto social não encontrado.',
  [ApiErrorCode.SOCIAL_PROJECTS_NAME_CONFLICT]:
    'Já existe um projeto social com este nome nesta congregação.',
  [ApiErrorCode.SOCIAL_PROJECTS_LEADER_NOT_FOUND]:
    'Responsável selecionado não encontrado.',
  [ApiErrorCode.SOCIAL_PROJECTS_LEADER_WRONG_CONGREGATION]:
    'O responsável deve pertencer a esta congregação.',
  [ApiErrorCode.SOCIAL_PROJECTS_MEMBER_NOT_FOUND]: 'Membro não encontrado.',
  [ApiErrorCode.SOCIAL_PROJECTS_MEMBER_WRONG_CONGREGATION]:
    'O membro deve pertencer a esta congregação.',
  [ApiErrorCode.SOCIAL_PROJECTS_MEMBER_ALREADY_LINKED]:
    'Membro já vinculado a este projeto social.',
  [ApiErrorCode.SOCIAL_PROJECTS_MEMBER_LINK_NOT_FOUND]:
    'Vínculo não encontrado.',
  [ApiErrorCode.SOCIAL_PROJECTS_SESSION_NOT_FOUND]: 'Sessão não encontrada.',
  [ApiErrorCode.SOCIAL_PROJECTS_SESSION_DATE_CONFLICT]:
    'Já existe uma sessão nesta data para o projeto.',
  [ApiErrorCode.SOCIAL_PROJECTS_ATTENDANCE_MEMBER_NOT_PARTICIPANT]:
    'O membro não é participante deste projeto social.',
  [ApiErrorCode.SOCIAL_PROJECTS_EXPENSE_NOT_FOUND]:
    'Despesa do projeto social não encontrada.',
  [ApiErrorCode.SOCIAL_PROJECTS_CATEGORY_NOT_FOUND]:
    'Categoria financeira "Ação social" não encontrada.',
} as const;
