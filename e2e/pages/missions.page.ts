...
export class MissionsPage extends BasePage {
  ...
  async gotoAssignments(): Promise<void> {
    ...
    await this.page
      .getByTestId("mission-assignment-create-btn")
  ...
  async openCreateAssignmentDialog(): Promise<void> {
    ...
    await this.page
      .getByTestId("mission-assignment-form")
      .waitFor({ state: "visible" });
  }
  ...
  async fillAssignmentForm(options: {
    ...
    await this.page
      .locator('[formcontrolname="memberId"]')
      .selectOption(options.memberId);
    await this.page
      .locator('[formcontrolname="missionFieldId"]')
      .selectOption(options.missionFieldId);
    await this.page
      .locator("#mission-assignment-start-date")
  ...
  async saveAssignmentForm(): Promise<void> {
    await this.page
      .getByTestId("mission-assignment-form")
      .getByRole("button", { name: /Salvar|Save|Guardar/i })
      .click();
    await this.page
      .getByTestId("mission-assignment-form")
