...
export const ApiErrorCode = {
  ...
  SECRETARIAT_GOOGLE_CALENDAR_NOT_CONFIGURED:
    'SECRETARIAT.GOOGLE_CALENDAR_NOT_CONFIGURED',
  SECRETARIAT_GOOGLE_CALENDAR_NOT_CONNECTED:
    'SECRETARIAT.GOOGLE_CALENDAR_NOT_CONNECTED',
  SECRETARIAT_GOOGLE_CALENDAR_OAUTH_FAILED:
    'SECRETARIAT.GOOGLE_CALENDAR_OAUTH_FAILED',
  SECRETARIAT_GOOGLE_CALENDAR_SYNC_FAILED:
    'SECRETARIAT.GOOGLE_CALENDAR_SYNC_FAILED',
  SECRETARIAT_GOOGLE_CALENDAR_ALREADY_CONNECTED:
    'SECRETARIAT.GOOGLE_CALENDAR_ALREADY_CONNECTED',
  ...
  MISSIONS_FIELD_NOT_FOUND: 'MISSIONS.FIELD_NOT_FOUND',
  MISSIONS_FIELD_NAME_IN_USE: 'MISSIONS.FIELD_NAME_IN_USE',
  MISSIONS_ASSIGNMENT_NOT_FOUND: 'MISSIONS.ASSIGNMENT_NOT_FOUND',
  MISSIONS_MEMBER_NOT_FOUND: 'MISSIONS.MEMBER_NOT_FOUND',
  MISSIONS_MEMBER_WRONG_CONGREGATION: 'MISSIONS.MEMBER_WRONG_CONGREGATION',
  MISSIONS_COORDINATOR_NOT_FOUND: 'MISSIONS.COORDINATOR_NOT_FOUND',
  MISSIONS_INVALID_DATES: 'MISSIONS.INVALID_DATES',

  CONSTRUCTIONS_PROJECT_NOT_FOUND: 'CONSTRUCTIONS.PROJECT_NOT_FOUND',
  CONSTRUCTIONS_PROJECT_NAME_IN_USE: 'CONSTRUCTIONS.PROJECT_NAME_IN_USE',
  CONSTRUCTIONS_UPDATE_NOT_FOUND: 'CONSTRUCTIONS.UPDATE_NOT_FOUND',
  CONSTRUCTIONS_PHOTO_NOT_FOUND: 'CONSTRUCTIONS.PHOTO_NOT_FOUND',
  CONSTRUCTIONS_PHOTOS_LIMIT_REACHED: 'CONSTRUCTIONS.PHOTOS_LIMIT_REACHED',
  CONSTRUCTIONS_UPDATE_WRONG_PROJECT: 'CONSTRUCTIONS.UPDATE_WRONG_PROJECT',
  CONSTRUCTIONS_MINISTRY_NOT_FOUND: 'CONSTRUCTIONS.MINISTRY_NOT_FOUND',
  CONSTRUCTIONS_MINISTRY_WRONG_CONGREGATION:
    'CONSTRUCTIONS.MINISTRY_WRONG_CONGREGATION',
  CONSTRUCTIONS_SUPERVISOR_NOT_FOUND: 'CONSTRUCTIONS.SUPERVISOR_NOT_FOUND',
  CONSTRUCTIONS_MEMBER_WRONG_CONGREGATION:
    'CONSTRUCTIONS.MEMBER_WRONG_CONGREGATION',
  CONSTRUCTIONS_INVALID_PROGRESS: 'CONSTRUCTIONS.INVALID_PROGRESS',
  CONSTRUCTIONS_INVALID_DATES: 'CONSTRUCTIONS.INVALID_DATES',
  CONSTRUCTIONS_EXPENSE_NOT_FOUND: 'CONSTRUCTIONS.EXPENSE_NOT_FOUND',
  CONSTRUCTIONS_CATEGORY_NOT_FOUND: 'CONSTRUCTIONS.CATEGORY_NOT_FOUND',
...
export const ApiErrorMessage = {
  ...
  [ApiErrorCode.SECRETARIAT_GOOGLE_CALENDAR_NOT_CONFIGURED]:
    'Integração com Google Calendar não configurada no servidor.',
  [ApiErrorCode.SECRETARIAT_GOOGLE_CALENDAR_NOT_CONNECTED]:
    'Google Calendar não está conectado para esta congregação.',
  [ApiErrorCode.SECRETARIAT_GOOGLE_CALENDAR_OAUTH_FAILED]:
    'Falha na autorização do Google Calendar.',
  [ApiErrorCode.SECRETARIAT_GOOGLE_CALENDAR_SYNC_FAILED]:
    'Falha ao sincronizar com o Google Calendar.',
  [ApiErrorCode.SECRETARIAT_GOOGLE_CALENDAR_ALREADY_CONNECTED]:
    'Já existe uma conexão Google Calendar ativa para esta congregação.',
  ...
  [ApiErrorCode.MISSIONS_FIELD_NOT_FOUND]: 'Campo missionário não encontrado.',
  [ApiErrorCode.MISSIONS_FIELD_NAME_IN_USE]:
    'Já existe um campo missionário com este nome na congregação.',
  [ApiErrorCode.MISSIONS_ASSIGNMENT_NOT_FOUND]:
    'Envio missionário não encontrado.',
  [ApiErrorCode.MISSIONS_MEMBER_NOT_FOUND]: 'Membro não encontrado.',
  [ApiErrorCode.MISSIONS_MEMBER_WRONG_CONGREGATION]:
    'Membro pertence a outra congregação.',
  [ApiErrorCode.MISSIONS_COORDINATOR_NOT_FOUND]: 'Coordenador não encontrado.',
  [ApiErrorCode.MISSIONS_INVALID_DATES]:
    'Datas inválidas para o envio missionário.',
  [ApiErrorCode.CONSTRUCTIONS_PROJECT_NOT_FOUND]: 'Obra não encontrada.',
  [ApiErrorCode.CONSTRUCTIONS_PROJECT_NAME_IN_USE]:
    'Já existe uma obra com este nome nesta congregação.',
  [ApiErrorCode.CONSTRUCTIONS_UPDATE_NOT_FOUND]: 'Andamento não encontrado.',
  [ApiErrorCode.CONSTRUCTIONS_PHOTO_NOT_FOUND]: 'Foto não encontrada.',
  [ApiErrorCode.CONSTRUCTIONS_PHOTOS_LIMIT_REACHED]:
    'Limite de 20 fotos por obra atingido.',
  [ApiErrorCode.CONSTRUCTIONS_UPDATE_WRONG_PROJECT]:
    'O andamento não pertence a esta obra.',
  [ApiErrorCode.CONSTRUCTIONS_MINISTRY_NOT_FOUND]: 'Ministério não encontrado.',
  [ApiErrorCode.CONSTRUCTIONS_MINISTRY_WRONG_CONGREGATION]:
    'Ministério pertence a outra congregação.',
  [ApiErrorCode.CONSTRUCTIONS_SUPERVISOR_NOT_FOUND]:
    'Responsável não encontrado.',
  [ApiErrorCode.CONSTRUCTIONS_MEMBER_WRONG_CONGREGATION]:
    'Membro pertence a outra congregação.',
  [ApiErrorCode.CONSTRUCTIONS_INVALID_PROGRESS]:
    'Percentual de progresso deve estar entre 0 e 100.',
  [ApiErrorCode.CONSTRUCTIONS_INVALID_DATES]: 'Datas inválidas para a obra.',
  [ApiErrorCode.CONSTRUCTIONS_EXPENSE_NOT_FOUND]:
    'Despesa da obra não encontrada.',
  [ApiErrorCode.CONSTRUCTIONS_CATEGORY_NOT_FOUND]:
    'Categoria financeira de obras não encontrada.',
